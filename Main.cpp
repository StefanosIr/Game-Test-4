...
void display() {
  glClearColor(0.0f, 0.2f, 0.1f, 0.5f);
...
int main(int argc, char ** argv) {
	...
	shared_ptr<Cube> p = shared_ptr<Cube> (new Cube(0, 0, 0,0));
	shared_ptr<IInterpolator> i = shared_ptr<IInterpolator>(new BallisticInterpolator(Vector3(7.0, 7.0, 0.0), 60));
	p->setInterpolator(i);
	assets.push_back(p);
	...
	assets.push_back(shared_ptr<WallAsset>(new WallAsset(35, 0, 0)));
